...
import {KeyboardPlayer, GamepadPlayer} from './player.js';
...
.then(opts => {
  ...
  elem.kbSelect.checked = false;
  elem.kbSelect.addEventListener('change', evt => {
    if (kbSelect.checked) {
  ...
  window.addEventListener('gamepadconnected', evt => {
    ...
    addKids(selectCntrls, cntrlSelect);
